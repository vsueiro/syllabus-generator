...
(function () {
  // Merge identical adjacent table cells
  (function mergeTables() {
    function mergeTable(table, replacer) {
      ...
      function mergeCells(table, colIndex) {
        ...
        for (let row of table.rows) {
          ...
          if (replacer) {
            check = firstCell.innerText !== replacer;
          } else if (headerCell) {
            check = firstCell.innerText !== headerCell.innerText;
          }

          if (headerCell === null || check) {
